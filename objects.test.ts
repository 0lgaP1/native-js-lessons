    ...
    governmentBuildings: [
      {
        ...
        budget: 200000,
        staffCount: 200,
        address: { street: "Central Str", number: 1 },
      },
      {
        type: "FIRE-STATION",
        budget: 500000,
        staffCount: 1000,
        address: { street: "Souths park str", number: 1 },
      },
    ],
...
//02.заполните объект city, чтоб тесты прошли
...
test.skip("city should contains 3 houses", () => {
  ...
  expect(city.houses[0].address.address).toBe(100);
